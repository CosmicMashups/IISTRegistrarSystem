...
<body background = "Pictures/building.jpg">
	...
	<div class = "tableee">
		<br><br><form method = "POST" action = "form138_add.php" enctype="multipart/form-data">
			<table class = "form">
				<tr>
                    <td> <br><input type = "hidden" name="form" value="Form138"></td>
                </tr> <tr>
                    <td colspan = "2"><font color = "#696969"> <h1> <b> Form 138 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; P100.00 </b></h1></font></td>
				</tr> <tr>
