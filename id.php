...
<body background = "Pictures/building.jpg">
	...
	<div class = "tableee">
		<br><br><form method = "POST" action = "id_add.php" enctype="multipart/form-data">
			<table class = "form">
				<tr>
                    <td> <br><input type = "hidden" name="form" value="ID"></td>
                </tr> <tr>
                    <td colspan = "2"><font color = "#696969"> <h1> <b> ID Replacement &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; P250.00 </b></h1></font></td>
				</tr> <tr>
