...
<body background = "Pictures/building.jpg">
	...
	<div class = "tableee">
		<br><br><form method = "POST" action = "graduation_add.php" enctype="multipart/form-data">
			<table class = "form">
				<tr>
                    <td> <br><input type = "hidden" name="form" value="Graduation"></td>
                </tr> <tr>
                    <td colspan = "2"><font color = "#696969"> <h1> <b> Certificate of Graduation &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; P50.00 </b></h1></font></td>
				</tr> <tr>
